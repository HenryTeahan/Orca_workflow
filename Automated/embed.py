...
if xyz_files and not (len(xyz_files) == 1 and xyz_files[0] in (None, "None")):
    for xyz in args.xyz_files:
        print("Failing in xyz step")
        path = Path(xyz)
        ...
        for i in range(len(stereo_confs)):
            ...
            print(df)       
elif args.smiles != None or args.smiles != "None":
